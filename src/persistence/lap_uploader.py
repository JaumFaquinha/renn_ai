        ...
        rows = [
            {
                ...
                # Multi-stat inputs (Proposal P1, 2026-04-25)
                "throttle_max": s.get("throttle_max"),
                "throttle_min": s.get("throttle_min"),
                "throttle_std": s.get("throttle_std"),
                "brake_max": s.get("brake_max"),
                "brake_min": s.get("brake_min"),
                "brake_std": s.get("brake_std"),
                "steering_max": s.get("steering_max"),
                "steering_min": s.get("steering_min"),
                "steering_std": s.get("steering_std"),
                "wheel_slip_fl_max": s.get("wheel_slip_fl_max"),
                "wheel_slip_fl_min": s.get("wheel_slip_fl_min"),
                "wheel_slip_fl_std": s.get("wheel_slip_fl_std"),
                "wheel_slip_fr_max": s.get("wheel_slip_fr_max"),
                "wheel_slip_fr_min": s.get("wheel_slip_fr_min"),
                "wheel_slip_fr_std": s.get("wheel_slip_fr_std"),
                "wheel_slip_rl_max": s.get("wheel_slip_rl_max"),
                "wheel_slip_rl_min": s.get("wheel_slip_rl_min"),
                "wheel_slip_rl_std": s.get("wheel_slip_rl_std"),
                "wheel_slip_rr_max": s.get("wheel_slip_rr_max"),
                "wheel_slip_rr_min": s.get("wheel_slip_rr_min"),
                "wheel_slip_rr_std": s.get("wheel_slip_rr_std"),
                "tc_active_max": s.get("tc_active_max"),
                "tc_active_min": s.get("tc_active_min"),
                "tc_active_std": s.get("tc_active_std"),
                "abs_active_max": s.get("abs_active_max"),
                "abs_active_min": s.get("abs_active_min"),
                "abs_active_std": s.get("abs_active_std"),
            }
